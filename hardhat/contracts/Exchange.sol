...
contract Exchange is ERC20 {
    ...
    // Exchange is inheriting ERC20 because our exchange would keep track of Crypto Dev LP tpkens
        ...
        */
        if(cryptoDevTokenReserve == 0){
            ...
            */
            ...
            // Ratio here to be maintained is -> (LP tokens to be sent to the user (liquidity)/ totalSupply of LP tokens in contract) = (Eth sent by the user)/(Eth reserve in the contract)
