...
export const addLiquidity = async (
  ...
  try {
    ...
    // Because CD Tokene are an ERC20, user would need to give the contract allowance to take the required number CD tokens out of his contract
    ...
    // After the contract has the approval, add the ether and cd tokens in the liquidity contract
